...
Heres the list of people currently in the pot:

```{r contestants, echo=FALSE, message=FALSE}
...
names <- c("David Lee", "Maria Prokopiou", "Nikita Driver", "Michael Archer",
           ...
           "Matt Ensor", "Isabella Worth")

knitr::kable(tibble(Name = names),row.names = TRUE)
...
There wont be much to see here until some football gets played.
